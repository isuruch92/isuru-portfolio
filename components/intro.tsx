...
export default function Intro() {
  ...
  return (
    <section
      id="home"
      ref={ref}
      className="mb-20 max-w-[60rem] sm:mb-0 scroll-mt-[100rem]"
    >
      <div className="flex flex-col smx1:flex-row gap-6 smx1:gap-10">
        ...
        <div className="flex flex-col justify-start items-center xsx1:items-start">
          <motion.h1
            className="mb-6 mt-0 smx1:mb-10 smx1:mt-4 sm:px-4 text-lg font-medium sm:!leading-[1.8] sm:tracking-wide text-justify sm:text-start sm:text-xl"
          ...
          >
            ...
            with&nbsp;
            <span className="font-bold text-amber-600">7+ years</span> of
            experience building{" "}
            ...
            <span className=" font-bold underline">Angular</span>, &{" "}
