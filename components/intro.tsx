...
export default function Intro() {
  ...
  return (
    ...
    >
      <div className="flex flex-col smx1:flex-row gap-6 smx1:gap-6">
        ...
        <div className="flex flex-col justify-start items-center xsx1:items-start">
          <motion.h1
            className="mb-6 mt-0  smx1:mt-6 sm:px-4 text-lg font-medium !leading-[2] sm:tracking-wide text-justify sm:text-start sm:text-xl"
          ...
          >
            ...
            <div className="h-2"></div>A seasoned{" "}
